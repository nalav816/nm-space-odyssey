            ...
            {new Array(7).fill(0).map((_, i) => (
                i % 3 == 0 && i != 0 ? (
                    <div className="flex" key={i}>
                        ...
                        <ColoredSprite color="blue" className="h-8 w-8  image-pixelated" spriteUrl="/sprites/platformBridgeRightTile.png" />
                        <ColoredSprite color="blue" className="h-8 w-8 image-pixelated" spriteUrl="/sprites/platformVertTile.png" />
                    </div>
                ) : (
                    <ColoredSprite color="blue" className="h-8 w-8  image-pixelated" spriteUrl="/sprites/platformVertTile.png" key={i} />
                )
            ))}

            <ColoredSprite color="blue" className="h-8 w-8  image-pixelated" spriteUrl="/sprites/platformBottomVertTile.png" />

            <div className="flex">
                <ColoredSprite color="blue" className="h-8 w-8  image-pixelated" spriteUrl="/sprites/platformLeftTile.png" />
                {new Array(minXTileToFill - 1).fill(0).map((_, i) =>
                (
                    <ColoredSprite color="blue" className="h-8 w-8  image-pixelated" spriteUrl="/sprites/platformTile.png" key={i} />
                )
                )}
                <ColoredSprite color="blue" className="h-8 w-16 image-pixelated" spriteUrl="/sprites/platformRightTile.png" />
            </div>
