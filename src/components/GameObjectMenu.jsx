    ...
    return (
        <div className={`flex flex-col items-center absolute -top-8 ${isXOffsetRight ?  "right-full" : "left-full"} ml-1 p-2 gap-2 z-50`}>
            ...
            <button onClick={onSellClick}
                className="relative animate-floatIn hover:cursor-pointer hover:to-red text-xs w-20 h-5 bg-radial to-red-dark from-red rounded shadow-md z-50 transform transition duration-200 ease-in-out hover:scale-105 border border-dashed border-red"
