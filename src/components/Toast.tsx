...
export default function Toast({ title = "Title", description} : {title?:string, description?:string}) {
    ...
    return (
        <div className="border-blue border box-shadow bg-linear-to-b from-blue to-blue-dark flex relative rounded w-80 min-h-8 text-white font-jaro">
            <div className="texture opacity-5 z-10" />
            <div className="flex items-center justify-center rounded-l relative min-w-12 min-h-8 bg-blue-dark border-r-2 border-blue z-30" >
