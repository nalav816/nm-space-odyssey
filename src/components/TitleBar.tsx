...
export default function TitleBar() {
    return (
         <div className="titlebar flex justify-center items-center px-4 py-1 soft-box-shadow card-radial-gradient relative border-b-2 border-blue-darker border-dashed w-full z-30">
