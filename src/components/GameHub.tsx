...
import { Store, Trophy, Atom } from "lucide-react";
    ...
    return (
        <div className={`${className}`}>
            <div className="absolute p-2 left-full flex flex-col items-center gap-3">
                ...
                <button onClick={() => setRenderedCard("Leaderboard")} className={`${renderedCard == "Leaderboard" ? "text-blue-light" : "hover:text-blue-light"}`}> <Trophy className="h-5 w-5" /> </button>
            </div>
